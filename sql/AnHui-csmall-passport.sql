-- csmall_ams
DROP DATABASE IF EXISTS csmall_ams;
CREATE DATABASE csmall_ams;
...
INSERT INTO ams_admin(username, password, nickname, avatar, phone, email, description, enable, login_count, gmt_create,
                      gmt_modified)
VALUES ('root', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '系统管理员',
        'https://img2.baidu.com/it/u=4244269751,4000533845&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '13900139001',
        'root@baidu.com', '最高权限的管理员', 1, 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('super_admin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '超级管理员',
        'https://img0.baidu.com/it/u=1600969112,4145041554&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '13900139002',
        'super_admin@baidu.cn', '超级管理员，通常具有除了【管理管理员】以外的全部权限', 1, 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('xiaoming', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '小明',
        ...
        '13900139003', 'liucangsong@baidu.cn', '小明的账号', 1, 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('lihua', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '李华',
        ...
        '13900139004', 'wangkejing@qq.com', '李华的账号', 0, 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('xiaozhi', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '小智',
        'https://img2.baidu.com/it/u=2704182461,2749837878&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '13900139005',
        'fanchuanqi@baidu.com', '小智的账号', 0, 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44');
...
VALUES (1, 1, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (2, 2, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (3, 3, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (4, 4, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (4, 5, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
...
INSERT INTO ams_permission(name, value, description, sort, gmt_create, gmt_modified)
VALUES ('后台管理-管理员-读取', '/ams/admin/read', '读取管理员信息，含查看列表、查看详情，及其它查询操作', 255, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-管理员-添加', '/ams/admin/add-new', '添加管理员', 254, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-管理员-删除', '/ams/admin/delete', '删除管理员', 253, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-管理员-修改', '/ams/admin/update', '修改管理员信息，含修改密码、启用、禁用、修改基本资料，及其它修改操作', 252, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-商品-读取', '/pms/product/read', '读取商品信息，含商品相关的所有数据的读取操作，查看列表、查看详情，及其它查询操作', 99, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-商品-添加', '/pms/product/add-new', '添加商品，含商品相关的所有数据的添加操作', 98, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-商品-删除', '/pms/product/delete', '删除商品，含商品相关的所有数据的删除操作', 97, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-商品-修改', '/pms/product/update', '修改商品信息，含商品相关的所有数据的修改操作，含所有修改操作', 96, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-品牌-列表', '/pms/brand/read', '读取品牌信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-品牌-添加', '/pms/brand/add-new', '添加品牌', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-品牌-删除', '/pms/brand/delete', '删除品牌', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-品牌-修改', '/pms/brand/update', '修改品牌信息，含修改基本资料、启用、禁用，及其它修改操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-类别-添加', '/pms/category/read', '读取类别信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-类别-添加', '/pms/category/add-new', '添加类别', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-类别-删除', '/pms/category/delete', '删除类别', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-类别-修改', '/pms/category/update', '修改类别信息，含修改基本资料、启用、禁用，及其它修改操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-图片-添加', '/pms/picture/read', '读取图片信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-图片-添加', '/pms/picture/add-new', '添加图片', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-图片-删除', '/pms/picture/delete', '删除图片', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-图片-修改', '/pms/picture/update', '修改图片信息，含所有修改操作', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-相册-添加', '/pms/album/read', '读取相册信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ('后台管理-相册-添加', '/pms/album/add-new', '添加相册', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-相册-删除', '/pms/album/delete', '删除相册', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       ('后台管理-相册-修改', '/pms/album/update', '修改相册信息，含所有修改操作', 0, '2022-07-08 11:30:44', '2022-07-08 11:30:44');
